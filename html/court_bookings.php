...
<body>
    ...
    <main>
        ...
        <section class="category-grid container my-5">
            <div class="row g-4">
                <!-- Category 1: Courts -->
                <div class="col-md-4">
                    <div class="card category-card" data-bs-toggle="modal" data-bs-target="#courtsModal">
                        <img src="../assets/images/courts.jpg" class="card-img-top" alt="Courts">
                        <div class="card-body">
    ...
    <!-- Balls Modal -->
    <div class="modal fade" id="courtsModal" tabindex="-1" aria-labelledby="ballsModalLabel" aria-hidden="true">
